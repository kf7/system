...
abstract class AbstractProfiler
{
    ...
    public static function start(string $group, string $name): string
    {
        ...
        $token = uniqid(static::$counter++, true);
        static::$marks[$token] = [
    ...
    /**
     * Deletes a benchmark. If an error occurs during the benchmark, it is recommended to delete the benchmark to
     * prevent statistics from being adversely affected.
     *
     * @param string $token Benchmark token.
     * @return void
     */
    ...
    public static function application()
    {
        ...
        // Note: DONT cache these, they are specific to the current request only.
